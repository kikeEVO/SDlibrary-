...
char walkPath(char *filepath, SdFile& parentDir,
		 char (*callback)(SdFile& parentDir,
				     char *filePathComponent,
				     char isLastComponent,
				     void *object),
		 void *object = NULL) {
  /*
  ...
  while (true) {
    ...
    char moreComponents = getNextPathComponent(filepath, &offset, buffer);

    char shouldContinue = callback((*p_parent), buffer, !moreComponents, object);
    ...
    char exists = (*p_child).open(*p_parent, buffer, O_RDONLY);
...
char callback_pathExists(SdFile& parentDir, char *filePathComponent,
			    char isLastComponent, void *object) {
  /*
  ...
  */
  ...
  char exists = child.open(parentDir, filePathComponent, O_RDONLY);
...
char callback_makeDirPath(SdFile& parentDir, char *filePathComponent,
			     char isLastComponent, void *object) {
  /*
...
char callback_openPath(SdFile& parentDir, char *filePathComponent,
			  char isLastComponent, void *object) {
...
char callback_remove(SdFile& parentDir, char *filePathComponent,
			char isLastComponent, void *object) {
  if (isLastComponent) {
...
char callback_rmdir(SdFile& parentDir, char *filePathComponent,
			char isLastComponent, void *object) {
  if (isLastComponent) {
    SdFile f;
...
char SDClass::exists(char *filepath) {
  /*
...
//char SDClass::exists(char *filepath, SdFile& parentDir) {
//  /*
//
...
char SDClass::mkdir(char *filepath) {
  /*
...
char SDClass::rmdir(char *filepath) {
  /*
...
char SDClass::remove(char *filepath) {
